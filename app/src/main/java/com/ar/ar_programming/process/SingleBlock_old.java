 ...
 * 単体処理ビュー
 */
public class SingleBlock_old extends ProcessBlock_old {
     ...
     * コンストラクタ
     */
    public SingleBlock_old(Context context, FragmentManager fragmentManager) {
        this(context, (AttributeSet) null);

        mFragmentManager = fragmentManager;
    }

    public SingleBlock_old(Context context) {
        this(context, (AttributeSet) null);
    }

    public SingleBlock_old(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SingleBlock_old(Context context, AttributeSet attrs, int defStyle) {

 ...
 * 単体処理ビュー
 */
public class SingleProcessBlock_old extends ProcessBlock_old {
     ...
     * コンストラクタ
     */
    public SingleProcessBlock_old(Context context, FragmentManager fragmentManager) {
        this(context, (AttributeSet) null);

        mFragmentManager = fragmentManager;
    }

    public SingleProcessBlock_old(Context context) {
        this(context, (AttributeSet) null);
    }

    public SingleProcessBlock_old(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SingleProcessBlock_old(Context context, AttributeSet attrs, int defStyle) {
